...
def main():
    ...
    parser.add_argument('--worker', required=True, help='JSON array of process argv; never passed to a local shell')
    ...
    try:
        ...
        for line in sys.stdin:
            ...
            try:
                ...
                print(json.dumps({'error': str(error), 'next_action': 'LOOK or STOP'}),flush=True)
    finally:
        worker.close()
